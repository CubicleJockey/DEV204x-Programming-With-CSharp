...
namespace ModuleEightAssignment.TurnInVersion
{
    public class Program
    {
        ...
        public void Main(string[] args)
        {
            ...
            var course = new Course("Dev204x", "Programming with C#", "Programming", 5, teacher, new List<Student> { student1, student2, student3 });
            var degree = new Degree("Bachelor", "Computer Science", 400, course);

            //List<T> created inline of Program constructor
            //Using object initalizer rather than .Add() methods
            //Documentation: https://msdn.microsoft.com/en-us/library/bb384062.aspx
            var program = new UProgram("Information Technology", new List<string> { "Bachelor", "Masters" }, teacher, degree);
